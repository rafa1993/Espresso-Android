...
public class ListaLeilaoTelaTest {
    ...
    public void deve_AparecerUmLeilao_QuandoCarregarUmLeilaoNaApi() throws IOException {
        ...
        onView(allOf(withText("Carro"), withId(R.id.item_leilao_maior_lance)))
                .check(matches(isDisplayed()));

        String formatoEsperado = formatadorDeMoeda.formata(0.0);

        onView(allOf(withText(formatoEsperado), withId(R.id.item_leilao_maior_lance))).check(matches(isDisplayed()));
    }
    ...
    public void deve_AparecerDoisLeiloes_QuandoCarregarDoisLeiloesDaApi() throws IOException {
        ...
        onView(allOf(withText(formatoEsperadoParaCarro), withId(R.id.item_leilao_maior_lance))).check(matches(isDisplayed()));
        ...
        onView(allOf(withText(formatoEsperadoParaComputador), withId(R.id.item_leilao_maior_lance))).check(matches(isDisplayed()));
    */
    ...
    private Matcher<? super View> apareceLeilao(final int posicao, final String descricaoEsperada,
        ...
        return new BoundedMatcher<View, RecyclerView>(RecyclerView.class) {
            ...
            protected boolean matchesSafely(RecyclerView item) {
                ...
                View textViewDescricao = viewDoViewHolder.findViewById(R.id.item_leilao_descricao);
