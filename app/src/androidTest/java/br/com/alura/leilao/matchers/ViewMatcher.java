...
public class ViewMatcher {
    ...
    public static Matcher<? super View> apareceLeilaoNaPosicao(final int posicaoEsperada, final String descricaoEsperada,
        ...
        return new BoundedMatcher<View, RecyclerView>(RecyclerView.class) {
            ...
            private boolean verificaDescricaoEsperada(View viewDoViewHolder) {
                ...
                return textViewDescricao.toString().equals(descricaoEsperada);
            }
        };
    }
}
